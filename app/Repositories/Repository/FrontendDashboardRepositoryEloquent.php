...
use App\Repositories\Contracts\FrontendDashboardRepository;
...
class FrontendDashboardRepositoryEloquent extends BaseRepository implements FrontendDashboardRepository
{
  /**
